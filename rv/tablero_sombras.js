...
var material1= new THREE.MeshLambertMaterial({color: 0xFF0000, transparent: true});
var material2= new THREE.MeshLambertMaterial({color: 0xFF0000, transparent: true});
var material3= new THREE.MeshLambertMaterial({color: 0xFFFFFF, transparent: true});
material.opacity=0.25;
material1.opacity=0.50;
...
for(var k=0; k<64; k++){
  for(var i=0; i<8; i++){
    for(var j=0; j<8; j++){
      if(a==2){
        cubo[k] = new THREE.Mesh( new THREE.BoxGeometry(10, 10, 4), new THREE.MeshLambertMaterial({color: 0xffffff}) );
        a=1;
      }else{
        cubo[k] = new THREE.Mesh( new THREE.BoxGeometry(10, 10, 4), new THREE.MeshLambertMaterial({color: 0x999999}) );
        a=2;
      }
